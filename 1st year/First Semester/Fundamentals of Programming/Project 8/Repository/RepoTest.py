...
class ActivityTest(unittest.TestCase):
    ...
    def test_activity_repo_add(self):
        ...
        repo.add_activity(Activity(11, [1, 2, 3], '2020.04.22', '09:20-15:30', 'shopping'))
        self.assertEqual(len(repo), 2)

        try:
            repo.add_activity(Activity(16, [1, 4, 3], '2020.04.22', '09:50-10:30', 'shopping'))
