from Repository.BinRepo import PersonBinFileRepository
...
class PersonService:
    ...
    def __init__(self, person_repo, validator: PersonValidator, undo_service: UndoService,
    ...
    def update(self, person: Person):
        ...
        """
        self._validator.is_person_valid(person)
        old_person = copy.deepcopy(self._repo.does_id_exist(person.person_id))
    ...
    def __getitem__(self, id_):
        ...
        for elem in self._repo.persons:
            if elem.person_id == id_:
                return elem
        raise PersonRepositoryException("Entity not found")
