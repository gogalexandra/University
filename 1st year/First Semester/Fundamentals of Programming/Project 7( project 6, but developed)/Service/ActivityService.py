...
from Repository.Activity_repo import ActivityRepositoryException
from Repository.BinRepo import ActivityBinFileRepository, PersonBinFileRepository
...
class ActivityService:
    ...
    def __init__(self, activity_repo, person_repo, validator: ActivityValidator, statistics: Statistics,
    ...
    def add(self, activity: Activity):
        ...
        for idd in activity.persons_id:
            if self._person_repo.does_id_exist(idd) is None:
    ...
    def update(self, activity: Activity):
        ...
        for idd in activity.persons_id:
            if self._person_repo.does_id_exist(idd) is None:
                raise ActivityRepositoryException('!!! Persons not in persons list !!!')
        self._validator.is_activity_valid(activity)
        old_activity = copy.deepcopy(self._repo.does_id_exist(activity.activity_id))
