...
class UI:
    ...
    def print_menu():
        ...
        print("19.Hamiltonian cycle with the lowest cost")
    ...
    def start(self):
        ...
        while not Done:
            ...
            if command == "0":
                ...
                cycle = self.Graph.MinimumCostHamiltonianCycle(start_vertex)
                if (cycle == None):
                    print("Graph has no Hamiltonian cycle!\n")
                else:
                    print("Lowest cost Hamiltonian cycle: ", cycle[0])
                    print("With cost: ", cycle[1], "\n")
            elif command == "20":
                self.Graph.BellmanFord(0)
            else:
                print("Wrong command! \n")
