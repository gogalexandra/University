...
public class PrgListController implements Initializable {
    ...
    private void buildProgramStatements()
    {
        ...
        IStmt fork1 = new CompStmt(new AcquireStmt("cnt"),
                new CompStmt(new wH("v1", new ArithExp('*', new rH(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                        new CompStmt(new PrintStmt(new rH(new VarExp("v1"))), new ReleaseStmt("cnt"))));

        IStmt fork2 = new CompStmt(new AcquireStmt("cnt"),
                new CompStmt(new wH("v1", new ArithExp('*', new rH(new VarExp("v1")), new ValueExp(new IntValue(10)))),
        ...
        IStmt ex11 = new CompStmt( new VarDeclStmt("v1", new RefType(new IntType())),
                new CompStmt(new VarDeclStmt("cnt", new IntType()),
                        new CompStmt(new newAlloc("v1", new ValueExp(new IntValue(1))),
                                new CompStmt(new CountSemaphoreStmt("cnt", new rH(new VarExp("v1"))),
