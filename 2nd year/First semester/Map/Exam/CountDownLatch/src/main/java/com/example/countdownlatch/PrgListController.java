...
public class PrgListController implements Initializable {
    ...
    private void buildProgramStatements()
    {
        ...
        IStmt fork3 = new CompStmt(
                new wH(
                        "v3",
                        new ArithExp('*', new rH(new VarExp("v3")), new ValueExp(new IntValue(10)))
                ),
                new CompStmt(
        ...
        IStmt ex11 =new CompStmt(new VarDeclStmt("cnt", new IntType()), new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new newAlloc("v1", new ValueExp(new IntValue(2))),
                                        new CompStmt(
                                                new newAlloc("v2", new ValueExp(new IntValue(3))),
                                                new CompStmt(
                                                        new newAlloc("v3", new ValueExp(new IntValue(4))),
                                                        new CompStmt(
                                                                new LatchStmt("cnt", new rH(new VarExp("v2"))),
                                                                new CompStmt(
                                                                        new ForkStmt(fork1),
                                                                        new CompStmt(
                                                                                new ForkStmt(fork2),
