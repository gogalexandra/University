...
public class PrgState {
    ...
    private MyIBarrier barrier;
    private MyIList<Value> output;
    private IStmt originalProgram;

    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIDictionary<Value, BufferedReader> fileTable, MyIHeap<Value> heap, MyIBarrier barrier, MyIList<Value> ot, IStmt prg){
        this.id = getThreadId();
        this.exeStack = stk;
    ...
    public MyIBarrier getBarrier() {return this.barrier;}
