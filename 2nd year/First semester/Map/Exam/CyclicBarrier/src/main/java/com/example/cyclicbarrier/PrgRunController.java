...
public class PrgRunController implements Initializable {
    ...
    @FXML
    private TableView<HashMap.Entry<Integer, Pair<Integer, ArrayList<Integer>>>> barrierTable;
    
    @FXML
    private TableColumn<HashMap.Entry<Integer,Pair<Integer, ArrayList<Integer>>>, String> barrierTableAddress;
    
    @FXML
    private TableColumn<HashMap.Entry<Integer,Pair<Integer, ArrayList<Integer>>>, String> barrierTableValue;
    
    @FXML
    private TableColumn<HashMap.Entry<Integer,Pair<Integer, ArrayList<Integer>>>, String> barrierTableArray;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle){
        ...
        barrierTableAddress.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getKey().toString()));
        barrierTableValue.setCellValueFactory(cellData -> new SimpleStringProperty(Integer.toString(cellData.getValue().getValue().getKey())));
        barrierTableArray.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getValue().getValue().toString()));
    ...
    private void populateBarrierTable(PrgState currentProgramState) {
        MyIDictionary<Integer, Pair<Integer, ArrayList<Integer>>> barrierTable = currentProgramState.getBarrier().getBarrier();
        List<Map.Entry<Integer, Pair<Integer, ArrayList<Integer>>>> barrierList = new ArrayList<>();

        for (Map.Entry<Integer, Pair<Integer, ArrayList<Integer>>> entry : barrierTable.getAll().entrySet())
            barrierList.add(entry);
        this.barrierTable.setItems(FXCollections.observableList(barrierList));
