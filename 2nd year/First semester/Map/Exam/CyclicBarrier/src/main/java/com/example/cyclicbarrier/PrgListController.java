    ...
    private void buildProgramStatements()
    {
        ...
        IStmt fork1 = new ForkStmt(new CompStmt(new AwaitStmt("cnt"),
                new CompStmt(new wH("v1", new ArithExp('*', new rH(new VarExp("v1")),
                        new ValueExp(new IntValue(10)))), new PrintStmt(new rH(new VarExp("v1"))))));

        IStmt fork2 = new ForkStmt(new CompStmt(new AwaitStmt("cnt"),
                new CompStmt(new wH("v2", new ArithExp('*', new rH(new VarExp("v2")),
                        new ValueExp(new IntValue(10)))), new CompStmt(
                        new wH("v2", new ArithExp('*', new rH(new VarExp("v2")),
                ...
                new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())),
                        new CompStmt(new VarDeclStmt("v3", new RefType(new IntType())),
                                new CompStmt(new newAlloc("v1", new ValueExp(new IntValue(2))),
                                        new CompStmt(new newAlloc("v2", new ValueExp(new IntValue(3))),
                                                new CompStmt(new newAlloc("v3", new ValueExp(new IntValue(4))),
                                                        new CompStmt(new VarDeclStmt("cnt", new IntType()),
                                                                new CompStmt(new BarrierStmt("cnt", new rH(new VarExp("v2"))),
