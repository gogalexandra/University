...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIDictionary<Value, BufferedReader> fileTable, MyIHeap<Value> heap, MyISemaphore semaphore, MyIList<Value> ot, IStmt prg){
        id = getThreadId();
        this.exeStack = stk;
    ...
    public MyISemaphore getSemaphore() { return semaphore; }
    ...
    public void setSemaphore(MyISemaphore semaphore) { this.semaphore = semaphore; }
