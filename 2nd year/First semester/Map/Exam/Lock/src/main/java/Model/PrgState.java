...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIDictionary<Value, BufferedReader> fileTable, MyIHeap<Value> heap, MyILock lockTable, MyIList<Value> ot, IStmt prg){
        this.id = getThreadId();
        this.exeStack = stk;
    ...
    public MyILock getLockTable() {return this.lockTable;}
