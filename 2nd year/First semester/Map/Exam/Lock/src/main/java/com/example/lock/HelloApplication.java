...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        mainLoader.setLocation(getClass().getClassLoader().getResource("RunForm.fxml"));
        ...
        secondaryLoader.setLocation(getClass().getClassLoader().getResource("SelectForm.fxml"));
