...
public class PrgState {
    ...
    public PrgState(int id, MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIDictionary<Value, BufferedReader> fileTable, MyIHeap<Value> heap, MyIList<Value> ot, IStmt prg){
        this.id = id;
        this.exeStack = stk;
