...
public class Main extends Application {
    ...
    private ListView<Text> outLV;
    private ListView<Text> fileTableLV;
    private ListView<Text> prgStsLV;

    private ListView<Text> allprgs;
    ...
    public void start(Stage stage) throws IOException {
        ...
        t1.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t2 = new Text(ex2.toString());
        t2.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t3 = new Text(ex3.toString());
        t3.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t4 = new Text(ex4.toString());
        t4.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t5 = new Text(ex5.toString());
        t5.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t6 = new Text(ex6.toString());
        t6.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t7 = new Text(ex7.toString());
        t7.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t8 = new Text(ex8.toString());
        t8.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t9 = new Text(ex9.toString());
        t9.wrappingWidthProperty().bind(allprgs.widthProperty());

        Text t10 = new Text(ex10.toString());
        t10.wrappingWidthProperty().bind(allprgs.widthProperty());

        allprgs.getItems().addAll(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10);
    }
