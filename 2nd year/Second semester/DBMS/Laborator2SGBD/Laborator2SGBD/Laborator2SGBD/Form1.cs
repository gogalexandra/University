...
namespace Laborator2SGBD
{
    public partial class Form1 : Form
    {
        ...
        string connectionString = "Data Source=Desktop-p9hv7vf;Initial Catalog=Planner;Integrated Security=True";
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            try
            {
                int deleteId = Int32.Parse(dataGridViewChild.SelectedRows[0].Cells[1].Value.ToString());
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            try
            {
                int childIdFromTable = Int32.Parse(dataGridViewChild.SelectedRows[0].Cells[1].Value.ToString());
