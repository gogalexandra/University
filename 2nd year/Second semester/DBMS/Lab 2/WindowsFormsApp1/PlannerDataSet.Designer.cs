...
namespace WindowsFormsApp1 {
    ...
    public partial class PlannerDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactsRow AddContactsRow(int id, string first_name, string last_name, string phone_number) {
            ...
            private void InitClass() {
                ...
                this.columnphone_number.MaxLength = 55;
            }
...
namespace WindowsFormsApp1.PlannerDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Contacts] WHERE (([id] = @Original_id) AND ([first_name] = @Or" +
                "iginal_first_name) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([las" +
                "t_name] = @Original_last_name)) AND ([phone_number] = @Original_phone_number))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contacts] ([id], [first_name], [last_name], [phone_number]) VA" +
                "LUES (@id, @first_name, @last_name, @phone_number);\r\nSELECT id, first_name, last" +
                "_name, phone_number FROM Contacts WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contacts] SET [id] = @id, [first_name] = @first_name, [last_name] = @last_name, [phone_number] = @phone_number WHERE (([id] = @Original_id) AND ([first_name] = @Original_first_name) AND ((@IsNull_last_name = 1 AND [last_name] IS NULL) OR ([last_name] = @Original_last_name)) AND ([phone_number] = @Original_phone_number));
SELECT id, first_name, last_name, phone_number FROM Contacts WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, first_name, last_name, phone_number FROM dbo.Contacts";
        ...
        public virtual int Fill(PlannerDataSet.ContactsDataTable dataTable) {
        ...
        public virtual PlannerDataSet.ContactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PlannerDataSet.ContactsDataTable dataTable = new PlannerDataSet.ContactsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PlannerDataSet.ContactsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_first_name, string Original_last_name, string Original_phone_number) {
        ...
        public virtual int Insert(int id, string first_name, string last_name, string phone_number) {
        ...
        public virtual int Update(int id, string first_name, string last_name, string phone_number, int Original_id, string Original_first_name, string Original_last_name, string Original_phone_number) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string phone_number, int Original_id, string Original_first_name, string Original_last_name, string Original_phone_number) {
